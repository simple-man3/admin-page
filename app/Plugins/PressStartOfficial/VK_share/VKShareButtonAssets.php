...
class VKShareButtonAssets extends AbstractExternalAssetPlugin
{
    public $position = AbstractExternalAssetPlugin::POS_INSIDE_HEAD;
    ...
    {
        return file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'assets.html');
    }
}
